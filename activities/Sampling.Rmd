...
They're pretty similar, but the population mean and sd tend to be less than that of the sample data. When the sample size is changed, only the sample data changes. It gets smaller. The population data does not change whatsoever.
