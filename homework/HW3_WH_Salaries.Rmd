...
A few of the employees have a salary of $0, such as David O. Sacks (WHITE HOUSE AI AND CRYPTO CZAR). A majority of the salaries range between 60000-200000. The results are pretty similar all throughout the data, which combined with the random $0 salaries may make for very skewed data.
...
```{r}
summarize(mean <- wh_salaries)
summarize(median <- wh_salaries)
```
