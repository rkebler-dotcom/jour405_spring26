...
There is a relatively strong correlation between the two variables, as the scatterplot shows a pretty diagonal line that follows the datapoints. However, there's a point where the GDP is around 25000 and the data sees a random jump, which I think could use some further research.
