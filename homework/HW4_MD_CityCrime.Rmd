...
"md_cities_rates" <- md_cities |> mutate("property_rate_2019" = property2019/pop2019 * 10000)
"md_cities_rates" <- md_cities |> mutate("violent_rate_2020" = violent2020/pop2020 * 10000)
"md_cities_rates" <- md_cities |> mutate("property_rate_2020" = property2020/pop2020 * 10000)
```
...
The rates for crimes definitely match the populations; it's larger for any area with more people/crime in general. However, some cities seem to have a higher property crime rate than violent crime rate, regardless of how much crime there is in said cities. 
...
```{r}
"md_cities_change" <- pct_change(violent_rate_2019)
```
